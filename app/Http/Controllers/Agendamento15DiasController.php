  ...
  public function store(StoreAgendamento_15_diasRequest $request)
    {
        ...
        $automovel=Automovel::get();
         ...
         //validando com tabela 3 dias 
            ...
            if(($request->dia1 ==$agendamento_3_dias1->dia1) or 
                ($request->dia1==$agendamento_3_dias1->dia2) or 
                ($request->dia1==$agendamento_3_dias1->dia3) or

                ($request->dia2==$agendamento_3_dias1->dia1) or 
                ($request->dia2==$agendamento_3_dias1->dia2) or 
                ($request->dia2==$agendamento_3_dias1->dia3) or

                ($request->dia3==$agendamento_3_dias1->dia1) or 
                ($request->dia3==$agendamento_3_dias1->dia2) or 
                ($request->dia3==$agendamento_3_dias1->dia3) or

                ($request->dia4==$agendamento_3_dias1->dia1) or 
                ($request->dia4==$agendamento_3_dias1->dia2) or 
                ($request->dia4==$agendamento_3_dias1->dia3) or

                ($request->dia5==$agendamento_3_dias1->dia1) or 
                ($request->dia5==$agendamento_3_dias1->dia2) or 
                ($request->dia5==$agendamento_3_dias1->dia3)

                ($request->dia6==$agendamento_3_dias1->dia1) or 
                ($request->dia6==$agendamento_3_dias1->dia2) or 
                ($request->dia6==$agendamento_3_dias1->dia3)                

                ($request->dia7==$agendamento_3_dias1->dia1) or 
                ($request->dia7==$agendamento_3_dias1->dia2) or 
                ($request->dia7==$agendamento_3_dias1->dia3) or

                ($request->dia8==$agendamento_3_dias1->dia1) or 
                ($request->dia8==$agendamento_3_dias1->dia2) or 
                ($request->dia8==$agendamento_3_dias1->dia3) or

                ($request->dia9==$agendamento_3_dias1->dia1) or 
                ($request->dia9==$agendamento_3_dias1->dia2) or 
                ($request->dia9==$agendamento_3_dias1->dia3) or

                ($request->dia10==$agendamento_3_dias1->dia1) or 
                ($request->dia10==$agendamento_3_dias1->dia2) or 
                ($request->dia10==$agendamento_3_dias1->dia3) or

                ($request->dia11==$agendamento_3_dias1->dia1) or 
                ($request->dia11==$agendamento_3_dias1->dia2) or 
                ($request->dia11==$agendamento_3_dias1->dia3) or

                ($request->dia12==$agendamento_3_dias1->dia1) or 
                ($request->dia12==$agendamento_3_dias1->dia2) or 
                ($request->dia12==$agendamento_3_dias1->dia3) or

                ($request->dia13==$agendamento_3_dias1->dia1) or 
                ($request->dia13==$agendamento_3_dias1->dia2) or 
                ($request->dia13==$agendamento_3_dias1->dia3) or

                ($request->dia14==$agendamento_3_dias1->dia1) or 
                ($request->dia14==$agendamento_3_dias1->dia2) or 
                ($request->dia14==$agendamento_3_dias1->dia3) or

                ($request->dia15==$agendamento_3_dias1->dia1) or 
                ($request->dia15==$agendamento_3_dias1->dia2) or 
                ($request->dia15==$agendamento_3_dias1->dia3){
