    ...
    <x-app-layout>
        ...
        <x-slot name="header">
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <h2></h2><br>
             <form action="{{route('Agendamento3Dias.update', ['id' => $Agendamento_3_dia->id])}}" method="post">
                 @if($errors->any())
<h4>{{$errors->first()}}</h4>
@endif
        @csrf
        ...
        {{-- Form Section 1 --}}
        <input type="text" name="dia1" class="form-control" value="{{$Agendamento_3_dia->dia1}}">
                
        <label>dia2</label>
        <input type="text" class="form-control" name="dia2" value="{{$Agendamento_3_dia->dia2}}">    
                
        <label>dia3</label><br>
        <input type="text" class="form-control" name="dia3" value="{{$Agendamento_3_dia->dia3}}"><br>
