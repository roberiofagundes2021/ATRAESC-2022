            ...
            <form action="{{route('Empresa.store')}}" method="post"             enctype="multipart/form-data">
               @if($errors->any())
                ...
                <div class="mb-3">
                    ...
                    <label for="formGroupExampleInput" class="form-label">CPNJ</label><br>
                    <input type="text" name="cpnj" placeholder="CPNJ"><br>
                           
                    <label for="formGroupExampleInput" class="form-label">solicitante</label><br>
                    <input type="text" name="solicitante" placeholder="solicitante"><br>
