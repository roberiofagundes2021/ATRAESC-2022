  ...
  <body class="app sidebar-mini">
    ...
    <x-app-layout>
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <label for="formGroupExampleInput" class="form-label">  renach</label><br>
            <input type="text" name="renach" placeholder="digite a renach"><br>

            <label for="formGroupExampleInput" class="form-label">idade</label><br>
            <input type="text" name="idade" placeholder="digite a idade"><br>

             <label for="formGroupExampleInput" class="form-label">sexo</label><br>
            <input type="text" name="sexo" placeholder="digite o sexo"><br>
