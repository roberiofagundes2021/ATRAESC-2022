...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <x-app-layout>
        ...
        <input type="text" class="form-control" name="renach" value="{{$Cliente->renach}}"><br>
                
        <label>idade</label><br>
        <input type="text" class="form-control" name="idade" value="{{$Cliente->idade}}"><br>

        <label>sexo</label><br>
        <input type="text" class="form-control" name="sexo" value="{{$Cliente->sexo}}"><br>
