    ...
    <x-app-layout>
        ...
        <x-slot name="header">
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <h2></h2><br>
             <form action="{{route('Automovel_atraesc.update', ['id' => $Automovel->id])}}" method="post">
        @csrf
        @method('PUT')
  
                
        <label>marca</label>
        <input type="text" class="form-control" name="marca" value="{{$Automovel->marca}}">    
                
        <label>modelo</label><br>
        <input type="text" class="form-control" name="modelo" value="{{$Automovel->modelo}}"><br>
                
        <label>placa</label><br>
        <input type="text" class="form-control" name="placa" value="{{$Automovel->placa}}"><br>
                
         <label>ano</label><br>
        <input type="text" class="form-control" name="ano" value="{{$Automovel->ano}}"><br>
          
        <label>cor</label><br>
        <input type="text" class="form-control" name="cor" value="{{$Automovel->cor}}"><br>
