  ...
  <body class="app sidebar-mini">
    ...
    <x-app-layout>
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <h2></h2><br>
            <form action="{{route('Automovel_atraesc.store')}}" method="post"             enctype="multipart/form-data">
                @csrf
                   @if($errors->any())
                ...
                <div class="mb-3">
                    <div class="pull-right">
                        ...
                        <a class="btn btn-primary" href="{{route('ATRAESC')}}">Voltar</a>
                    </div>
                            ...
                            <label for="formGroupExampleInput" class="form-label">placa</label><br>
                            <input type="text" name="placa" placeholder="placa"><br><br>    
                            <label for="formGroupExampleInput" class="form-label">ano</label><br>
                            <input type="text" name="ano" placeholder="ano"><br><br>   

                             <label for="formGroupExampleInput" class="form-label">cor</label><br>
