           ...
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <form action="{{route('EnderecoEmpresa.store')}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pais" placeholder="digite o País"><br>
                    ...
                    <input type="text" name="cidade" placeholder="digite o nome da cidade"><br>

                    <label for="formGroupExampleInput" class="form-label">Bairro</label><br>
                    <input type="text" name="bairro" placeholder="digite o nome do bairro"><br>
                    ...
                    <input type="text" name="rua" placeholder="digite o nome da rua"><br><br>
                     ...
                     <label for="formGroupExampleInput" class="form-label">numero da casa</label><br>
                    <input type="text" name="numero" placeholder="digite o numero da casa"><br><br>

                      <input type="hidden" name="empresa_id" value="{{$id}}"><br><br>

                       <label for="formGroupExampleInput" class="form-label">quantidade de dias que vai agendar</label><br>
                            <select name="qtd_dias_agendado">
