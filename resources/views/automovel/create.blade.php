                ...
                <div class="mb-3">
                    <div class="pull-right">
                        ...
                        <a class="btn btn-primary" href="{{route('dashboard')}}">Voltar</a>
                            ...
                            <label for="formGroupExampleInput" class="form-label">Nome do carro</label><br>
                            <input type="text" name="nome" placeholder="Nome do carro"><br>

                             <label for="formGroupExampleInput" class="form-label">marca</label><br>
                            <input type="text" name="marca" placeholder="marca do carro"><br>

                             <label for="formGroupExampleInput" class="form-label">modelo</label><br>
                            <input type="text" name="modelo" placeholder="modelo do carro"><br>
                           
                             <label for="formGroupExampleInput" class="form-label">instrutor</label><br>
                            <input type="text" name="instrutor" placeholder="instrutor do carro"><br><br>

                            <input type="text" name="agendamento_Com_Habilitacao_id" value="{{$id}}">
