    ...
    <x-app-layout>
        ...
        <x-slot name="header">
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <h2></h2><br>
             <form action="{{route('feriado.update', ['id' => $feriado->id])}}" method="post">
        @csrf
        @method('PUT')
        <label for="nome">nome do feriado</label>
        {{-- Form Section 1 --}}
        <input type="text" name="nome" class="form-control" value="{{$feriado->nome}}">
                
        <label>data</label>
        <input type="text" class="form-control" name="data" value="{{$feriado->data}}">    
