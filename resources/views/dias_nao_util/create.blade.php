           ...
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <form action="{{route('feriado.store')}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <label for="formGroupExampleInput" class="form-label">dia não util</label><br>
                    <input type="text" name="nome" placeholder="digite o nome dia não util"><br>

                    <label for="formGroupExampleInput" class="form-label">data</label><br>
                    <input type="date" name="data" placeholder="digite a data do dias não util"><br><br>
