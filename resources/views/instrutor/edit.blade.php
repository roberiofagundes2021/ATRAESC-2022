    ...
    <x-app-layout>
        ...
        <x-slot name="header">
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <h2></h2><br>
             <form action="{{route('Instrutor.update', ['id' => $Instrutor->id])}}" method="post">
        @csrf
        @method('PUT')
  
                
        <label>nome</label>
        <input type="text" class="form-control" name="nome" value="{{$Instrutor->nome}}">    
                
        <label>cpf</label><br>
        <input type="text" class="form-control" name="cpf" value="{{$Instrutor->cpf}}"><br>
                
        <label>rg</label><br>
        <input type="text" class="form-control" name="rg" value="{{$Instrutor->rg}}"><br>
                
         <label>habilitação</label><br>
        <input type="text" class="form-control" name="habilitacao" value="{{$Instrutor->habilitacao}}"><br>
