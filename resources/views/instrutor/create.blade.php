  ...
  <body class="app sidebar-mini">
    ...
    <x-app-layout>
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <h2></h2><br>
            <form action="{{route('Instrutor.store')}}" method="post"             enctype="multipart/form-data">
                @csrf
                   @if($errors->any())
                ...
                <div class="mb-3">
                    <div class="pull-right">
                        ...
                        <a class="btn btn-primary" href="{{route('dashboard')}}">Voltar</a>
                            ...
                            <label for="formGroupExampleInput" class="form-label">Nome do instrutor</label><br>
                            <input type="text" name="nome" placeholder="digite o nome do instrutor"><br>

                             <label for="formGroupExampleInput" class="form-label">CPF</label><br>
                            <input type="text" name="cpf" placeholder="digite o cpf do instrutor"><br>

                            <label for="formGroupExampleInput" class="form-label">RG</label><br>
                            <input type="text" name="rg" placeholder="digite o rg do instrutor"><br><br>

                             <label for="formGroupExampleInput" class="form-label">Habilitção</label><br>
                            <input type="text" name="habilitacao" placeholder="digite o nunmero da Habilitção"><br><br>
